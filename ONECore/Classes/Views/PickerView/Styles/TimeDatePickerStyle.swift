//
//  TimeDatePickerStyle.swift
//  Alamofire
//
//  Created by ALDO LAZUARDI on 04/06/20.
//

import UIKit

open class TimeDatePickerStyle: DatePickerStyle {
    ...
    open var displayFormat: String = DateFormat.time
    public init() {}
}
